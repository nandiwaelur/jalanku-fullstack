        ...
        >
          ...
          >
            <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
              {session && (
                <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] ">
                  ...
                  >
                    ...
                    />
                    <h1 className="text-white font-semibold text-xl ml-3 truncate" >
                      {session.user.name}
                    </h1>
                  </button>
              ...
              <Link className="font-semibold text-xl text-white hover:bg-gradient-to-r hover:bg-clip-text hover:text-transparent hover:from-[#1EB47D] hover:to-[#34E0A1]" href="/about">
                About
              </Link>
            </div>
          </div>
